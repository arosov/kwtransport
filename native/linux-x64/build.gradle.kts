...
mavenPublishing {
    coordinates(project.group.toString(), "kwtransport-jvm-linux-x64", project.version.toString())

    pom {
        name.set("kwtransport-jvm-linux-x64")
        description.set("Linux x64 native binary for kwtransport")
