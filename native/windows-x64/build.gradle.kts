...
mavenPublishing {
    coordinates(project.group.toString(), "kwtransport-jvm-windows-x64", project.version.toString())

    pom {
        name.set("kwtransport-jvm-windows-x64")
        description.set("Windows x64 native binary for kwtransport")
