...
mavenPublishing {
    coordinates(project.group.toString(), "kwtransport-jvm-macos-arm64", project.version.toString())

    pom {
        name.set("kwtransport-jvm-macos-arm64")
        description.set("macOS arm64 native binary for kwtransport")
