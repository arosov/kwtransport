...
Press `Esc` to hide this help
  ...
  15. [**7.** Packages, Crates, and Modules](https://doc.rust-lang.org/book/ch07-00-managing-growing-projects-with-packages-crates-and-modules.html)
  ...
  28.     1. [**13.1.** Closures](https://doc.rust-lang.org/book/ch13-01-closures.html)
  ...
  35. [**17.** Fundamentals of Asynchronous Programming: Async, Await, Futures, and Streams](https://doc.rust-lang.org/book/ch17-00-async-await.html)
  36.     1. [**17.1.** Futures and the Async Syntax](https://doc.rust-lang.org/book/ch17-01-futures-and-syntax.html)
  ...
  37. [**18.** Object Oriented Programming Features](https://doc.rust-lang.org/book/ch18-00-oop.html)
  38.     1. [**18.1.** Characteristics of Object-Oriented Languages](https://doc.rust-lang.org/book/ch18-01-what-is-oo.html)
  ...
  39. [**19.** Patterns and Matching](https://doc.rust-lang.org/book/ch19-00-patterns.html)
  40.     1. [**19.1.** All the Places Patterns Can Be Used](https://doc.rust-lang.org/book/ch19-01-all-the-places-for-patterns.html)
  ...
  41. [**20.** Advanced Features](https://doc.rust-lang.org/book/ch20-00-advanced-features.html)
  42.     1. [**20.1.** Unsafe Rust](https://doc.rust-lang.org/book/ch20-01-unsafe-rust.html)
  ...
  43. [**21.** Final Project: Building a Multithreaded Web Server](https://doc.rust-lang.org/book/ch21-00-final-project-a-web-server.html)
  44.     1. [**21.1.** Building a Single-Threaded Web Server](https://doc.rust-lang.org/book/ch21-01-single-threaded.html)
  ...
  45. [**22.** Appendix](https://doc.rust-lang.org/book/appendix-00.html)
  46.     1. [**22.1.** A - Keywords](https://doc.rust-lang.org/book/appendix-01-keywords.html)
...
[ ](https://doc.rust-lang.org/book/print.html "Print this book") [ ](https://github.com/rust-lang/book "Git repository")
...
### [Controlling Access with Mutexes](https://doc.rust-lang.org/book/ch16-03-shared-state.html#controlling-access-with-mutexes)
_Mutex_ is an abbreviation for _mutual exclusion_ , as in a mutex allows only one thread to access some data at any given time. To access the data in a mutex, a thread must first signal that it wants access by asking to acquire the mutex’s lock. The _lock_ is a data structure that is part of the mutex that keeps track of who currently has exclusive access to the data. Therefore, the mutex is described as _guarding_ the data it holds via the locking system.
...
#### [Shared Access to `Mutex<T>`](https://doc.rust-lang.org/book/ch16-03-shared-state.html#shared-access-to-mutext)
...
### [Comparing `RefCell<T>`/`Rc<T>` and `Mutex<T>`/`Arc<T>`](https://doc.rust-lang.org/book/ch16-03-shared-state.html#comparing-refcelltrct-and-mutextarct)
...
[ ](https://doc.rust-lang.org/book/ch16-02-message-passing.html "Previous chapter") [ ](https://doc.rust-lang.org/book/ch16-04-extensible-concurrency-sync-and-send.html "Next chapter")
[ ](https://doc.rust-lang.org/book/ch16-02-message-passing.html "Previous chapter") [ ](https://doc.rust-lang.org/book/ch16-04-extensible-concurrency-sync-and-send.html "Next chapter")
